...
fun ContentScaleExamplesPage() {
    val composition by rememberLottieComposition(LottieCompositionSpec.Asset("gradient.json"))
...
private fun OptionsRow(
    ...
    Row(
        ...
        Row(
            ...
            Icon(
                imageVector = if (scaleExpanded) Icons.Filled.ArrowForward else Icons.Filled.ArrowDropDown,
        ...
        Row(
            ...
            Icon(
                imageVector = if (alignmentExpanded) Icons.Filled.ArrowForward else Icons.Filled.ArrowDropDown,
                contentDescription = null,
            )
            DropdownMenu(
                alignmentExpanded,
