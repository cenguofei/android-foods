...
private fun Example1() {
    ...
    val composition by rememberLottieComposition(LottieCompositionSpec.Asset("heart.json"))
    LottieAnimation(composition)
}

@Composable
private fun Example2() {
    val composition by rememberLottieComposition(LottieCompositionSpec.Asset("sun_moon.json"))
    LottieAnimation(composition)
}
...
private fun Example3() {
    val composition by rememberLottieComposition(
        LottieCompositionSpec.Asset("we_accept_inline_image.json"),
